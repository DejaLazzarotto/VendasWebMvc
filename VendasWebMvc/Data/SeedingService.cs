...
namespace VendasWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(1, "Juli Lazzarotto", "juli@gmail.com", new DateTime(1973, 1, 19), 5000.0, d1);
            Seller s3 = new Seller(1, "Máximo Lazzarotto", "max@gmail.com", new DateTime(2001, 8, 24), 11000.0, d1);
            Seller s4 = new Seller(1, "Julia Lazzarotto", "juh@gmail.com", new DateTime(2005, 5, 22), 12000.0, d1);
            Seller s5 = new Seller(1, "Dalva Damiani", "dalva@gmail.com", new DateTime(1948, 4, 21), 20000.0, d1);
            Seller s6 = new Seller(1, "Oscar de Luca", "oscar@gmail.com", new DateTime(1978, 8, 5), 3000.0, d1);
